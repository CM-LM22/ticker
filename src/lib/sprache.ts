...
const DE = {
  ...
  tabXetra: 'Xetra',
  xetraLeer: 'Noch keine eigenen Xetra-Titel. Oben im Suchfeld einen Titel suchen und hinzufuegen — zum Entfernen die Titelzelle nach links wischen.',
  entfernen: 'Entfernen',
...
const EN: Texte = {
  ...
  berichteLink: 'Reports',
  tabXetra: 'Xetra',
  xetraLeer: 'No own Xetra stocks yet. Search above and add one — swipe the name cell left to remove.',
  entfernen: 'Remove',
  reportOriginal: 'Report (original)',
